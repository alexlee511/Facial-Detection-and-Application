...
#input_image ='face_many.jpg'
input_image ='face_.jpg'
...
for rect in rects:
    ...
    current_deal = deal.resize((shades_width, int(shades_width * deal.size[1]\
                                / deal.size[0])),resample=Image.LANCZOS)
...
animation.write_gif("deal_face.gif", fps=4)
